...
/* Align the slide/pselect mechanism with the device-tested e2s profile:
 * confirm the pselect syscall is actually blocked in do_select before the
 * consumer triggers sched_setattr, so the requeue deadlock's fake waiter
 * lands inside the live fd_set; keep the DZG1 Snapdragon bank geometry. */
...
#define SYSCTL_BOOTID_OFF 0x026046e8ULL
#define ASHMEM_MISC_OFF 0x023bb5a0ULL
